...
it.instance("plan agent denies edits except .localcode-agent/plans/* and .opencode/plans/*", () =>
  Effect.gen(function* () {
    ...
    expect(Permission.evaluate("edit", ".localcode-agent/plans/foo.md", plan!.permission).action).toBe("allow")
