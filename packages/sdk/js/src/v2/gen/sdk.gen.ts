...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the localcode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the localcode system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the localcode server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local localcode state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global localcode configuration settings and preferences.
   */
   ...
   *
   * Update global localcode configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the localcode server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the localcode system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all localcode instances, releasing all resources.
   */
   ...
   * Upgrade localcode
   *
   * Self-update is not available in localcode; this route always returns 400.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current localcode configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update localcode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current localcode instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the localcode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Lsp extends HeyApiClient {
   ...
   *
   * Every language server localcode can run, whether it is installed, and what installing would download.
   */
  public catalog<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<LspCatalogResponses, LspCatalogErrors, ThrowOnError>({
      url: "/lsp/catalog",
      ...options,
      ...params,
    })
   ...
   *
   * User-requested: download (if needed) and start one language server for this project.
   */
  public install<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      lspInstallInput?: LspInstallInput
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
      ...
      [
        {
          args: [
            { in: "query", key: "directory" },
            { in: "query", key: "workspace" },
            { key: "lspInstallInput", map: "body" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).post<LspInstallResponses, LspInstallErrors, ThrowOnError>({
      url: "/lsp/install",
      ...options,
      ...params,
      headers: {
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with localcode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that localcode is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by localcode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all localcode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new localcode session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific localcode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Interrupt active execution owned by this localcode process. Idle interruption is a no-op.
   */
