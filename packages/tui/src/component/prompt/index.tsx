...
export function Prompt(props: PromptProps) {
  ...
  function promptModelWarning() {
    toast.show({
      variant: "warning",
      message: "No model loaded. Use /models to pick a local model before sending prompts",
      duration: 3000,
    })
  }
                    ...
                    <>
                      ...
                      <Show when={store.mode === "normal"}>
                        <box flexDirection="row" gap={1}>
                          ...
                          >
                            {modelChanging() ? "Model changing…" : modelLoaded() ? local.model.parsed().model : supervisorKnown() ? "No model loaded · /models" : "Model service not running · exit and run localcode again"}
